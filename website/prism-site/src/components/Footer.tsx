        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><a href="https://github.com/your-username/prism-ts" target="_blank" rel="noopener noreferrer">GitHub Repository</a></li>
              <li><a href="https://github.com/your-username/prism-ts/releases" target="_blank" rel="noopener noreferrer">Download</a></li>
              <li><a href="https://github.com/your-username/prism-ts/issues" target="_blank" rel="noopener noreferrer">Report Issues</a></li>
            </ul>
          </div>
          ...
          <div className="footer-section">
            <h4>Community</h4>
            <ul className="footer-links">
              <li><a href="https://github.com/your-username/prism-ts/discussions" target="_blank" rel="noopener noreferrer">Discussions</a></li>
              <li><a href="https://github.com/your-username/prism-ts/wiki" target="_blank" rel="noopener noreferrer">Wiki</a></li>
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><a href="https://github.com/your-username/prism-ts/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer">Contributing Guide</a></li>
              <li><a href="https://github.com/your-username/prism-ts/blob/main/LICENSE" target="_blank" rel="noopener noreferrer">License</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            ...
            <div className="footer-social">
              <a href="https://github.com/your-username/prism-ts" target="_blank" rel="noopener noreferrer" className="social-link">
                <span>GitHub</span>
              </a>
