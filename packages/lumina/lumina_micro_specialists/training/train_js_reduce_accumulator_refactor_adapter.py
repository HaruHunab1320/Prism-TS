...
def main():
    p = argparse.ArgumentParser(description="Train a contract-matched adapter-style uplift for js_reduce_accumulator_refactor.")
    p.add_argument("--data-root", type=Path, default=Path("lumina_micro_specialists/data/datasets/js_reduce_accumulator_refactor_v1"))
    ...
    out_dir = args.output_dir / f"js_reduce_accumulator_refactor_{safe_model}_gen"
