...
def main():
    p = argparse.ArgumentParser(description="Train a contract-matched adapter-style uplift for js_array_loop_to_map.")
    p.add_argument("--data-root", type=Path, default=Path("lumina_micro_specialists/data/datasets/js_array_loop_to_map_v1"))
    ...
    out_dir = args.output_dir / f"js_array_loop_to_map_{safe_model}_gen"
