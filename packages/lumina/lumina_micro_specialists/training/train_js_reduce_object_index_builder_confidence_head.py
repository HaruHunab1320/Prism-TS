...
def main() -> None:
    p = argparse.ArgumentParser(description="Train a confidence probe for js_reduce_object_index_builder.")
    p.add_argument("--train-dataset", type=Path, default=Path("lumina_micro_specialists/data/datasets/js_reduce_object_index_builder_v1/probe_train_v2.jsonl"))
    p.add_argument("--val-dataset", type=Path, default=Path("lumina_micro_specialists/data/datasets/js_reduce_object_index_builder_v1/hard_val_v2.jsonl"))
    p.add_argument("--model", required=True)
    p.add_argument("--max-train-samples", type=int, default=256)
    p.add_argument("--max-val-samples", type=int, default=128)
    p.add_argument("--max-new-tokens", type=int, default=128)
    p.add_argument("--epochs", type=int, default=40)
    p.add_argument("--batch-size", type=int, default=64)
    p.add_argument("--lr", type=float, default=1e-3)
    p.add_argument("--hidden-dim", type=int, default=16)
    p.add_argument("--output", type=Path, default=Path("lumina_micro_specialists/outputs/js_reduce_object_index_builder_confidence_probe.pt"))
    p.add_argument("--metrics-json", type=Path, default=Path("lumina_micro_specialists/notes/js_reduce_object_index_builder_confidence_probe_latest.json"))
    args = p.parse_args()
