...
WEIGHT_GENERAL="${WEIGHT_GENERAL:-outputs_gpt2/general_gpt2_confidence.pt}"
WEIGHT_MATH="${WEIGHT_MATH:-outputs_gpt2/math_gpt2_confidence.pt}"
WEIGHT_CODE="${WEIGHT_CODE:-outputs_gpt2/code_gpt2_confidence.pt}"
ROUTER_WEIGHTS="${ROUTER_WEIGHTS:-outputs_router/router.pt}"
ROUTER_LABELS="${ROUTER_LABELS:-outputs_router/labels.json}"
