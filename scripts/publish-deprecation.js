...
const deprecatedPackage = {
  ...
  version: '1.0.23',
  description: 'DEPRECATED - Please use @prism-lang/core instead',
  main: 'index.js',
  scripts: {
  ...
  homepage: 'https://github.com/HaruHunab1320/Prism-TS#readme',
  license: 'MIT'
};
...
console.error('=====================================');
console.error('prism-uncertainty has been moved to @prism-lang/core');
console.error('');
console.error('Please update your dependencies:');
console.error('  npm uninstall prism-uncertainty');
console.error('  npm install @prism-lang/core');
console.error('');
console.error('Then update your imports:');
console.error('  OLD: import { parse } from "prism-uncertainty"');
console.error('  NEW: import { parse } from "@prism-lang/core"');
console.error('=====================================\\n\\n');

throw new Error('prism-uncertainty is deprecated. Please install @prism-lang/core instead.');
`;
...
console.log('=====================================');
console.log('prism-uncertainty has moved to @prism-lang/core');
console.log('');
console.log('Migration instructions:');
console.log('  1. npm uninstall prism-uncertainty');
console.log('  2. npm install @prism-lang/core');
console.log('  3. Update imports from "prism-uncertainty" to "@prism-lang/core"');
console.log('');
console.log('For more info: https://github.com/HaruHunab1320/Prism-TS');
console.log('=====================================\\n\\n');
`;
